...
\title{Protect Yourself from \emph{p}-Hacking:\\ 7 Things to Do to\\ Avoid Committing Academic Malpractice}		
\author{
    Frederick Solt\\
...
% \input{06_multiply_impute_missing_data}	% Erico
...
% \input{16_multiply_impute_missing_data_example}
