...
\usepackage{appendix}	% Offer more settings in appendix
...
\usepackage[capitalise,noabbrev]{cleveref} %automatically detect type of reference by label, using \cref{key} instead of \ref{key}
